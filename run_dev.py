"""Development runner: start FastAPI (uvicorn) and Streamlit together.

Usage: python run_dev.py

This spawns two subprocesses:
- Uvicorn serving the API from app.server:app on port 8000
- Streamlit serving the UI from streamlit_app/main.py on port 8501
